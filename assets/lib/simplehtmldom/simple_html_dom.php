...
namespace TRP_Simplehtmldom{
    ...
    define('TRP_MAX_FILE_SIZE', 600000);
// helper functions
// -----------------------------------------------------------------------------
// get html dom from file
// $maxlen is defined in the code as PHP_STREAM_COPY_ALL which is defined as -1.
    function file_get_html($url, $use_include_path = false, $context = null, $offset = -1, $maxLen = -1, $lowercase = true, $forceTagsClosed = true, $target_charset = TRP_DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = TRP_DEFAULT_BR_TEXT, $defaultSpanText = TRP_DEFAULT_SPAN_TEXT)
    {
