        ...
        <table id="trp-options" class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if( !empty( $this->settings['g-translate-key'] ) ) echo '<a href="https://www.googleapis.com/language/translate/v2?key='.$this->settings['g-translate-key'].'&source=en&target=es&q=something" target="_blank">Test API Key</a>'; ?>
                    <p class="description">
