<div id="trp-addons-page" class="wrap">
    ...
    <div class="grid">
        <div class="grid-cell" style="overflow:hidden;">
            <a href="https://translatepress.com/pricing/" target="_blank"><img src="<?php echo plugins_url('../assets/images/translator-accounts-addon.png', __FILE__) ?>" alt="Language by GET parameter " style="float: left; margin: 0 1.5rem 1.5rem 0;"></a>
