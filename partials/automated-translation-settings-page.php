            ...
            <tr>
                ...
                <td>
                    <select id="trp-auto-translator" name="trp_automated_translation_settings[translator]" class="trp-select">
                        <option value="disabled" <?php selected( $this->settings_automated_translations['translator'], 'disabled' ); ?>><?php _e( 'Disabled', 'translatepress-multilingual') ?></option>
                    ...
                    <p class="description">
                        <?php _e( 'Enable or disable the automatic translation of the site. Only untranslated strings will receive a translation.<br>You can later edit these automatic translations.<br>Note: Not all languages support automatic translation.', 'translatepress-multilingual' ); ?>
                    </p>
                </td>
            </tr>
